...
# representación de los clusters
ggplot(r_red_train, aes(x = distance, y = trip_duration, color = factor(db$cluster))) + geom_point()
...
Como hemos visto en los algoritmos anteriores, el número óptimo de clusteres que podemos crear son entorno a 3 y 4. Estos numeros son correctos, ya que coinciden con los que estabamos buscando. 
